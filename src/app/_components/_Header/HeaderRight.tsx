...
export default function HeaderRight() {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      // popupToast({ color: "red", pos: "top", message: "다른 친구가 편집하고 있어요. 나중에 다시 시도해 주세요." });
      // popupToast({ color: "green", pos: "top", message: "내 위키 링크가 복사되었습니다." });
      // popupToast({ color: "gray", pos: "top", message: "앞 사람의 편집이 끝나면 위키 참여가 가능합니다." });
    };
