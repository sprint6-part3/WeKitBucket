    ...
    <AnimatePresence>
      {isOpen && (
        <motion.aside
          ...
          exit={{ opacity: 0 }}
        >
          <div className="mx-2 flex h-auto w-[335px] flex-col rounded-[10px] bg-gray-50 p-[20px] shadow-lg md:w-[395px]">
            ...
            <div className="flex justify-end gap-4">
              <motion.button
                className="hover:bg-grayscale-400 rounded-md bg-gray-200 px-4 py-2 hover:text-gray-50"
                initial={{ scale: 1 }}
                whileTap={{ scale: 0.9 }}
                onClick={onCancel}
              >
              ...
              <motion.button
                className="rounded-md bg-primary-green-200 px-4 py-2 text-gray-50 hover:bg-primary-green-300"
                initial={{ scale: 1 }}
                whileTap={{ scale: 0.9 }}
                onClick={onConfirm}
              >
